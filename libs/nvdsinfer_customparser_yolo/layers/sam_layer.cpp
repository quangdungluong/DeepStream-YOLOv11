...
nvinfer1::ITensor *samLayer(int layerIdx, std::string activation,
  ...
  nvinfer1::IElementWiseLayer *sam = network->addElementWise(
      *input, *samInput, nvinfer1::ElementWiseOperation::kPROD);
  assert(sam != nullptr);
