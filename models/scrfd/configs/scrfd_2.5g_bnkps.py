...
img_norm_cfg = dict(mean=[127.5, 127.5, 127.5], std=[128.0, 128.0, 128.0], to_rgb=True)
train_pipeline = [
    ...
    dict(type="Resize", img_scale=(640, 640), keep_ratio=False, bbox_clip_border=False),
...
model = dict(
    ...
    backbone=dict(
        ...
        depth=0,
        block_cfg=dict(
            block="BasicBlock", stage_blocks=(3, 5, 3, 2), stage_planes=[24, 48, 48, 80]
        ),
        base_channels=24,
        num_stages=4,
        out_indices=(0, 1, 2, 3),
